...
win = tk.Tk()
img = PhotoImage(file=r"img\ECOSOFT_LOGO.png")
...
def InitUI():
    ...
    win.title('Створення PDF файлів для установок, пакування, гарантійного талона')
...
def dropDownList(row):
    ...
    combo = ttk.Combobox(win, textvariable=chosed_SKU, values=SKU, width=20)
...
def PrintShield(pdf, rowSKU, rowCH, rowDate, listSKU, pad_x, pad_y):
    ...
    pdf.add_font('arialB', '', 'fonts/arial_bold.ttf')
    ...
    pdf.cell(txt='REVERSE', w=35, h=2.8, border=0, align='L')
    pdf.cell(txt='СИСТЕМА', w=35, h=2.8, border=0, align='L', ln=1)
    pdf.cell(txt='OSMOSIS', w=35, h=2.8, border=0, align='L')
    pdf.cell(txt='ЗВОРОТНОГО', w=35, h=2.8, border=0, align='L', ln=1)
    pdf.cell(txt='SYSTEM', w=35, h=2.5, border=0, align='L')
    pdf.cell(txt='ОСМОСУ', w=35, h=2.8, border=0, align='L', ln=1)
    ...
    pdf.cell(txt='Код: ' + model_SKU, w=34, h=2.8, border=0, align='L', ln=1)
    pdf.cell(txt='Manufacturing date:', w=34, h=2.8, border=0, align='L')
    pdf.cell(txt='Дата виготовлення:', w=34, h=2.8, border=0, align='L', ln=1)
    ...
    pdf.cell(txt='Напруга живлення:', w=34, h=2.8, border=0, align='L', ln=1)
    ...
    pdf.cell(txt='ТОВ «НВО «ЕКОСОФТ»', w=34, h=2.8, border=0, align='L', ln=1)

    pdf.set_font('arial', '', 7.5)
    pdf.cell(txt='QMS ISO 9001:2015', w=34, h=2.8, border=0, align='L')
    pdf.cell(txt='СУЯ ISO 9001:2015', w=34, h=2.8, border=0, align='L', ln=1)
...
def PrintPackingSticker(pdf, rowSKU, rowCH, rowDate, listSKU):
    ...
    pdf.cell(w=68, h=6.0, txt=raw, border=0,
             ln=1)
    pdf.cell(w=0, h=10.0, txt=descrUA,
             ln=1)

    pdf.add_font('arialB', '', 'fonts/arial_black.ttf')
...
def GuaranteeStikers_12pcs():
    ...
    PrintGuaranteeSticker(pdf, sku_variable, serial_variable, date_variable)
...
Label(win, text='', bg='#EBEBEB', padx=20).grid(row=1, column=3, columnspan=1)
...
combo2 = ttk.Combobox(win, textvariable=sku_variable_2, values=SKU, width=20)
combo2['state'] = 'readonly'
combo2.grid(column=1, row=3, padx=3, pady=3)

combo3 = ttk.Combobox(win, textvariable=sku_variable_3, values=SKU, width=20)
combo3['state'] = 'readonly'
combo3.grid(column=1, row=4, padx=3, pady=3)

combo4 = ttk.Combobox(win, textvariable=sku_variable_4, values=SKU, width=20)
combo4['state'] = 'readonly'
combo4.grid(column=1, row=5, padx=3, pady=3)

combo5 = ttk.Combobox(win, textvariable=sku_variable_5, values=SKU, width=20)
combo5['state'] = 'readonly'
combo5.grid(column=1, row=6, padx=3, pady=3)

combo6 = ttk.Combobox(win, textvariable=sku_variable_6, values=SKU, width=20)
combo6['state'] = 'readonly'
combo6.grid(column=1, row=7, padx=3, pady=3)

combo7 = ttk.Combobox(win, textvariable=sku_variable_7, values=SKU, width=20)
combo7['state'] = 'readonly'
combo7.grid(column=1, row=8, padx=3, pady=3)

combo8 = ttk.Combobox(win, textvariable=sku_variable_8, values=SKU, width=20)
combo8['state'] = 'readonly'
combo8.grid(column=1, row=9, padx=3, pady=3)

combo9 = ttk.Combobox(win, textvariable=sku_variable_9, values=SKU, width=20)
combo9['state'] = 'readonly'
combo9.grid(column=1, row=10, padx=3, pady=3)

combo10 = ttk.Combobox(win, textvariable=sku_variable_10, values=SKU, width=20)
combo10['state'] = 'readonly'
combo10.grid(column=1, row=11, padx=3, pady=3)

combo11 = ttk.Combobox(win, textvariable=sku_variable_11, values=SKU, width=20)
combo11['state'] = 'readonly'
combo11.grid(column=1, row=12, padx=3, pady=3)

combo12 = ttk.Combobox(win, textvariable=sku_variable_12, values=SKU, width=20)
...
#   Напис "розробник"
Label(win, text='made by maksym.protsak@gmail.com', bg='#EBEBEB', fg='#808080').grid(
